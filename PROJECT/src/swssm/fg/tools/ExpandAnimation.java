...
public class ExpandAnimation extends Animation {
    ...
    public ExpandAnimation(View view, int duration) {
        ...
        Log.i("test", mIsVisibleAfter+" : "+mWasEndedAlready);
        if(mIsVisibleAfter)
        	Global.list.setActivated(false);
        else if(!mIsVisibleAfter)
        	Global.list.setActivated(true);
